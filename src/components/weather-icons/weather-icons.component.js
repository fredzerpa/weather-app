...
export const Cloudy = ({ width, height }) => {
...
export const Rainy = ({ width, height }) => {
  const classes = useStyles();
  return (
    <div className='element'>
      <svg
...
export const CloudyWithSun = ({ width, height }) => {
  const classes = useStyles();
  return (
    <div className='element'>
      <svg
        ...
        style={{
          enableBackground: 'new 0 0 61.7 42.8',
          width: width ?? height,
          height: height ?? width,
        }}
      >
...
export const CloudyWithLightning = ({ width, height }) => {
  const classes = useStyles();
  return (
    <div className='element'>
      <svg
...
export const CloudyWithMoon = ({ width, height }) => {
  const classes = useStyles();
  return (
    <div className='element'>
      <svg
...
export const CloudyWithRainAndLightning = ({ width, height }) => {
  const classes = useStyles();
  return (
    <div className='element'>
      <svg
...
export const Sunny = ({ width, height }) => {
  const classes = useStyles();
  return (
    <div className='element'>
      <svg
        ...
        style={{
          enableBackground: 'new 0 0 44.9 44.9',
          width: width ?? height,
          height: height ?? width,
        }}
      >
...
export const ClearNight = ({ width, height }) => {
  const classes = useStyles();
  return (
    <div className='element'>
      <svg
        ...
        style={{
          enableBackground: 'new 0 0 30.8 42.5',
          width: width ?? height,
          height: height ?? width,
        }}
      >
...
export const SunnyWithWind = ({ width, height }) => {
  const classes = useStyles();
  return (
    <div className='element'>
      <svg
        ...
        style={{
          enableBackground: 'new 0 0 45.1 47.6',
          width: width ?? height,
          height: height ?? width,
        }}
      >
...
export const Snowy = ({ width, height }) => {
  const classes = useStyles();
  return (
    <div className='element'>
      <svg
      ...
      >
        <g id='Cloud_7'>
          ...
          <circle className={classes.white} cx='37' cy='43.5' r='3'>
            <animateTransform
              attributeName='transform'
              dur='1.5s'
          ...
          <circle className={classes.white} cx='27' cy='43.5' r='3'>
            <animateTransform
              attributeName='transform'
              dur='1.5s'
              keyTimes='0;0.33;0.66;1'
          ...
          <circle className={classes.white} cx='17' cy='43.5' r='3'>
            <animateTransform
              attributeName='transform'
              dur='1.5s'
              keyTimes='0;0.33;0.66;1'
